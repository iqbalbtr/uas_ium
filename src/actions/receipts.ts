...
export const createReceipt = async (
  ...
  await createActivityLog((user) => ({
    action_name: "Membuat Resep",
    action_type: "create",
    description: `${user.name} membuat informasi resep`,
    title: "Membuat Resep",
  }));
...
export const removeReceipt = async (id: number) => {
  ...
  await createActivityLog((user) => ({
    action_name: "Menghapus Resep",
    action_type: "delete",
    description: `${user.name} menghapus informasi resep`,
    title: "Menghapus Resep",
  }));
...
export const updateReceipt = async (
  ...
  await createActivityLog((user) => ({
    action_name: "Mengupdate Resep",
    action_type: "update",
    description: `${user.name} mengupdate informasi resep`,
    title: "Mengupdate resep",
  }));

  return "Update recipe successfully";
};

export const getReceipt = async (page: number = 1, limit: number = 15) => {
